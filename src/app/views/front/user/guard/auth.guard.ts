...
const unauthorizedPages = ['etudiant','foyer','admin','universite','bloc','chambre','reservation','dashboard'];
    ...
    if (this.service.isloggedin()) {
      ...
      if (
        ...
        ((this.service.getrole() === 'user' &&  decodedRole.toString() == 'user') || (this.service.getrole() == 'admin' &&  decodedRole.toString() == 'user')))
        // && this.service.getrole().toString() == Globals.roleA.toString()
         {
